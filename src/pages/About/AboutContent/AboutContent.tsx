      ...
      <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-2xl p-4 md:p-8 lg:p-12 shadow-2xl backdrop-blur-sm">
        <div className="space-y-6 md:space-y-8">
          ...
          <section className="max-w-[800px] mx-auto">
            <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-4 md:p-6 lg:p-8 transition-all duration-300 hover:border-[rgba(100,108,255,0.5)]">
                ...
                <div className="flex-shrink-0 mt-2 md:mt-6">
                  ...
                  <div className="flex justify-center gap-1.5 md:gap-2 mt-3 md:mt-4 flex-wrap">
                    ...
                    <a
                      ...
                      className="flex items-center justify-center w-10 h-10 bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-lg transition-all duration-300 hover:border-[rgba(100,108,255,0.5)] hover:bg-[rgba(100,108,255,0.05)] group"
                    >
                      <FaLinkedin className="w-4 h-4 md:w-5 md:h-5 text-[var(--text-secondary)] group-hover:text-[#0077B5] transition-colors duration-300" />
                    </a>
                    ...
                    <a
                      ...
                      className="flex items-center justify-center w-10 h-10 bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-lg transition-all duration-300 hover:border-[rgba(100,108,255,0.5)] hover:bg-[rgba(100,108,255,0.05)] group"
                    >
                      <svg className="w-4 h-4 md:w-5 md:h-5 text-[var(--text-secondary)] group-hover:text-[#EA4335] transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a
                      ...
                      className="flex items-center justify-center w-10 h-10 bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-lg transition-all duration-300 hover:border-[rgba(100,108,255,0.5)] hover:bg-[rgba(100,108,255,0.05)] group"
                    >
                      <svg className="w-4 h-4 md:w-5 md:h-5 text-[var(--text-secondary)] group-hover:text-[#00EA64] transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a
                      ...
                      className="flex items-center justify-center w-10 h-10 bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-lg transition-all duration-300 hover:border-[rgba(100,108,255,0.5)] hover:bg-[rgba(100,108,255,0.05)] group"
                    >
                      <svg className="w-4 h-4 md:w-5 md:h-5 text-[var(--text-secondary)] group-hover:text-[#FFA116] transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          <section className="max-w-[800px] mx-auto">
            <div className="grid md:grid-cols-2 gap-4 md:gap-6">
              ...
              <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-4 md:p-6 transition-all duration-300 hover:border-[rgba(100,108,255,0.5)]">
                <h3 className="text-[18px] md:text-[22px] text-[var(--text-primary)] font-semibold mb-3 md:mb-4 flex items-center gap-2">
